...
import Swipephoto3 from './src/Screens/Swipephoto3';
import Swipephoto4 from './src/Screens/Swipephoto4';
  ...
  return (
    <NavigationContainer>
      ...
      <Stack.Screen options={{ headerShown: false }} name="Homepage" component={Homepage} />
        ...
        <Stack.Screen options={{ headerShown: false }} name="Swipephoto" component={Swipephoto} />
        <Stack.Screen options={{ headerShown: false }} name="Swipephoto2" component={Swipephoto2} />
